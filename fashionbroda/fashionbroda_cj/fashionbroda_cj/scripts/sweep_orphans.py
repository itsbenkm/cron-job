#!/usr/bin/env python3
"""
Sweep orphaned images from the R2 bucket (fashionbroda).
...
from fashionbroda_cj.scripts.purge_deleted_r2 import collect_keys, worker_delete_keys
...
def main():
    ...
    from fashionbroda_cj.scripts.read_db import read_active_products
