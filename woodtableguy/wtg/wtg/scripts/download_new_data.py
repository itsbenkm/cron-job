...
INPUT_JSON = DATA_DIR / "new_album_data.json"
OUTPUT_JSON = DATA_DIR / "new_album_data_updated_cdn.json"
...
def main():
    ...
    if isinstance(raw_data, dict):
        ...
        raise TypeError(
            f"Expected JSON object or array in {args.input_json}, got {type(raw_data).__name__}"
        )
